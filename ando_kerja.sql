...
--
-- Host: localhost
-- Generation Time: Feb 03, 2024 at 06:39 AM
...
(5, '2024_02_03_051701_create_invoice_table', 1),
(6, '2024_02_03_052125_create_detail_invoice_table', 1);
...
--
ALTER TABLE `detail_invoice`
  ADD CONSTRAINT `detail_invoice_id_invoice_foreign` FOREIGN KEY (`id_invoice`) REFERENCES `invoice` (`id`);
COMMIT;
